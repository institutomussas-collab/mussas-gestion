...
export default function App() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif', backgroundColor: '#0d0d0d', color: '#ffffff' }}>
      {/* Sidebar Negro Puro + Detalle Blanco y Fucsia Vibrante #ff0055 */}
        ...
        <div style={{ textAlign: 'center', marginBottom: '35px' }}>
          <div style={{ width: '85px', height: '85px', margin: '0 auto 10px auto', borderRadius: '50%', border: '2px solid #ff0055', padding: '5px', backgroundColor: '#111' }}>
            <svg viewBox="0 0 500 500" width="100%" height="100%">
              <circle cx="250" cy="250" r="230" fill="none" stroke="#ff0055" strokeWidth="6" />
              <path d="M 120 280 C 180 120 320 120 380 280" fill="none" stroke="#00e5ff" strokeWidth="12" strokeLinecap="round" />
              <circle cx="250" cy="160" r="25" fill="#00e5ff" />
            </svg>
          </div>
