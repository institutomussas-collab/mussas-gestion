...
export default function Clases() {
  ...
  const formInicial = {
    nombre: '', categoriaEdad: '6 a 10 años', profesor: '', diasHorarios: '', aula: 'Sala 1'
  };
  ...
  const cargarDatos = async () => {
    try {
      ...
      const qProf = await getDocs(collection(db, 'profesores'));
      setProfesores(qProf.docs.map(d => ({ id: d.id, ...d.data() })));
